...
if (process.env.FACEBOOK_APP_ID && process.env.FACEBOOK_APP_SECRET) {
    ...
    new FacebookStrategy(
      {
        ...
        callbackURL:
          ...
          `${SERVER_BASE_URL}/api/auth/facebook/callback`,
  ...
  console.warn(
    "Facebook OAuth credentials not found. Facebook authentication will not be available.",
  );
}
...
if (process.env.TWITTER_CONSUMER_KEY && process.env.TWITTER_CONSUMER_SECRET) {
    ...
    new TwitterStrategy(
      {
        ...
        callbackURL:
          ...
          `${SERVER_BASE_URL}/api/auth/twitter/callback`,
        includeEmail: true,
      },
  ...
  console.warn(
    "Twitter OAuth credentials not found. Twitter authentication will not be available.",
  );
}
...
if (process.env.INSTAGRAM_CLIENT_ID && process.env.INSTAGRAM_CLIENT_SECRET) {
    ...
    new InstagramStrategy(
      {
        ...
        callbackURL:
          ...
          `${SERVER_BASE_URL}/api/auth/instagram/callback`,
      },
      async (accessToken, refreshToken, profile, done) => {
        try {
  ...
  console.warn(
    "Instagram OAuth credentials not found. Instagram authentication will not be available.",
  );
}
