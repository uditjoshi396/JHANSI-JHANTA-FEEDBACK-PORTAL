...
const MONGO_URI =
  process.env.MONGO_URI || "mongodb://localhost:27017/janata_portal";
...
if (!process.env.SESSION_SECRET) {
  console.warn(
    "[config] SESSION_SECRET is not set. Using insecure fallback secret.",
  );
}
...
app.get("/", (req, res) =>
  res.json({ status: "Janata Feedback API", time: new Date() }),
);
